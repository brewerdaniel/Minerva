...
#==============================================================================
  ...
  return 0
	...
	# X1 = ( 2021, 2424, 2008, 1606, 1950, 2032 );Y1 = ( 2439, 2028, 1612, 2021, 2025, 1979 );Z1 = ( 2064, 2059, 2038, 2046, 1622, 2437 );X2 = ( -30, -748, 112, 746, 548, -440 );Y2 = ( -783, 105, 815, 119, 93, 205 );Z2 = ( 370, 432, 387, -421, 680, -651 )
